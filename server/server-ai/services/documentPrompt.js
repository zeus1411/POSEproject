const buildDocumentPrompt = ({ question, context, chatHistory = '' }) => {
  return [
    ...
    'Each factual claim from the context must include the relevant citation ID like [S1] or [S2].',
    'Do not put all citations only at the end; place citations next to the claim they support.',
    'Never cite a source that does not directly support the claim.',
