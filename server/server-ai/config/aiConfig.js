...
const CATALOG_MIN_USEFUL_ANSWER_CHARS = Number(process.env.CATALOG_MIN_USEFUL_ANSWER_CHARS || 60);
const CATALOG_AUTO_SYNC_ENABLED =
  String(process.env.CATALOG_AUTO_SYNC_ENABLED ?? 'true').toLowerCase() === 'true';
...
export {
  ...
  CATALOG_MIN_USEFUL_ANSWER_CHARS,
